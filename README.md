...
### 2. Tolerances 
When designing the case, I found it hard to imagine the atcual size of everything. The maths was a little hard to understand, but that got easier over time.
